...
async function readLoginRulesState(userId: string) {
  const select =
    "trading_rules_accepted, login_rules_seen_at, starting_capital, current_capital, risk_per_trade_percent, daily_profit_target_percent, weekly_profit_target_amount, weekly_target_from, weekly_target_to, daily_loss_limit_percent, max_consecutive_losses";
